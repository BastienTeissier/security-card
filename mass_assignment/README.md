# Mass assignment: Wrong move on the API, Real off-track moment 🏎️💥
...
This immediately caught their attention 🎯: could this be vulnerable to **Mass Assignment**?

**What is a Mass Assignment 🧐:** A modification endpoint accepts more fields than it should. An attacker can sneak in extra parameters—like a role field—to escalate from a regular user to an administrator.
